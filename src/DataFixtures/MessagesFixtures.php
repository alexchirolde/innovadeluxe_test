...
class MessagesFixtures extends BaseFixtures implements DependentFixtureInterface
{
    ...
    public function loadData(ObjectManager $manager)
    {
        ...
        foreach ($conversations as $conversation) {
            ...
            $tmpParticipant = $participants[rand(0, count($participants) - 1)];
            $participantTo = $tmpParticipant == $participantFrom ? $participants[rand(0, count($participants) - 1)] : $tmpParticipant;
